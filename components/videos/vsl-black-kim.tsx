...
export default function VSLBlackKim() {
  useEffect(() => {
    const loadPlayerScript = () => {
      if (document.querySelector('script[src*="68eacce8d469876bc12a4ed1"]')) return;
      const script = document.createElement("script");
      script.src = "https://scripts.converteai.net/655331ad-f855-4d28-8b01-a97e04c93f76/players/68eacce8d469876bc12a4ed1/v4/player.js";
      script.async = true;
      script.onload = () => {
    ...
    return () => {
      const existingScript = document.querySelector('script[src*="68eacce8d469876bc12a4ed1"]');
      if (existingScript) {
